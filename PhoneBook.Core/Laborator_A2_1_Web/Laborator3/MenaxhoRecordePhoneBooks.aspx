<%@ Page Language="C#" AutoEventWireup="true"  UnobtrusiveValidationMode="None" CodeBehind="MenaxhoRecordePhoneBooks.aspx.cs" Inherits="Laborator_A2_1_Web.Laborator3.MenaxhoRecordePhoneBooks" %>
        ...
        <div>
            ...
            <asp:Panel runat="server" ID="panel1">
                <fieldset>
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="shtoRecord" runat="server" ID="rfl1" ControlToValidate="txtPhoneBookPersonName" ErrorMessage="Ju lutem plotesoni emrin" ForeColor="Red"> </asp:RequiredFieldValidator>
                    <br />
                    <asp:Label runat="server" ID="Label1">
                        PhoneBookNumber
                    </asp:Label>
                    <asp:TextBox runat="server" ID="txtPhoneNumber"></asp:TextBox>
                    <asp:RequiredFieldValidator ValidationGroup="shtoRecord" runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtPhoneNumber"
                        ErrorMessage="Ju lutem plotesoni numrin e telefonit" ForeColor="Red"> </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ValidationGroup="shtoRecord" runat="server" ID="rex1" ControlToValidate="txtPhoneNumber"
                    ...
                    <asp:RadioButtonList ID="rdlPhoneBookType" runat="server">
                      ...
                      <asp:RequiredFieldValidator ValidationGroup="shtoRecord" runat="server" ID="RequiredFieldValidator2" ControlToValidate="rdlPhoneBookType"
                        ErrorMessage="Ju lutem plotesoni tipin e nr e telefonit" ForeColor="Red"
                           InitialValue=""></asp:RequiredFieldValidator>
                  
                    <br />
                    <asp:Button ID="btnShto" runat="server" OnClick="btnShto_Click" ValidationGroup="shtoRecord" Text="Shto record" />


                    <br /> 

                    <asp:Button runat ="server" ID="fshirecord" Text="Fshi Record"   OnClick="fshirecord_Click"/>
                </fieldset>
